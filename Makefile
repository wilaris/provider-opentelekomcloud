...
PROJECT_REPO := go.wilaris.de/$(PROJECT_NAME)
...
IMAGES = provider-opentelekomcloud
...
XPKGS = provider-opentelekomcloud
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider OpenTelekomCloud CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider OpenTelekomCloud controllers
...
# This target prepares repo for your provider by replacing all "opentelekomcloud"
