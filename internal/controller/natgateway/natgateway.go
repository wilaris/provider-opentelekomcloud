...
const (
	...
	errValidateSpec      = "invalid NATGateway spec"
	errEmptyExternalName = "external name is empty"
	errObserveNATGateway = "cannot observe NATGateway"
	errObserveTags       = "cannot observe NATGateway tags"
	errCreateNATGateway  = "cannot create NATGateway"
	errUpdateNATGateway  = "cannot update NATGateway"
	errDeleteNATGateway  = "cannot delete NATGateway"
...
func SetupGated(mgr ctrl.Manager, o controller.Options) error {
	...
	}, networkv1alpha1.NATGatewayGroupVersionKind)
	return nil
}

// Setup adds a controller that reconciles NATGateway managed resources.
func Setup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(networkv1alpha1.NATGatewayGroupKind)

	opts := []managed.ReconcilerOption{
		managed.WithTypedExternalConnector[*networkv1alpha1.NATGateway](&connector{
			kube: mgr.GetClient(),
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		stateMetricsRecorder := statemetrics.NewMRStateRecorder(
			...
			&networkv1alpha1.NATGatewayList{},
			o.MetricOptions.PollStateMetricInterval,
		)
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(
				err,
				"cannot register MR state metrics recorder for kind networkv1alpha1.NATGatewayList",
			)
		}
	}
	...
	r := managed.NewReconciler(
		mgr,
		resource.ManagedKind(networkv1alpha1.NATGatewayGroupVersionKind),
		opts...,
	)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&networkv1alpha1.NATGateway{}).
...
var _ managed.TypedExternalConnector[*networkv1alpha1.NATGateway] = (*connector)(nil)
...
func (c *connector) Connect(
	ctx context.Context,
	mg *networkv1alpha1.NATGateway,
) (managed.TypedExternalClient[*networkv1alpha1.NATGateway], error) {
...
var _ managed.TypedExternalClient[*networkv1alpha1.NATGateway] = (*external)(nil)
...
func (e *external) Observe(
	...
	if err := validateNATGatewayParameters(cr.Spec.ForProvider); err != nil {
	...
	if err != nil {
		...
		return managed.ExternalObservation{}, errors.Wrap(err, errObserveNATGateway)
	}
	...
	// set observation
	cr.Status.AtProvider = networkv1alpha1.NATGatewayObservation{
		ID:           observed.ID,
		Name:         observed.Name,
	...
	lateInitializeNATGateway(cr, observed, observedTags, li)

	return managed.ExternalObservation{
		ResourceExists: true,
		ResourceUpToDate: isNATGatewayUpToDate(
			cr.Spec.ForProvider,
			observed,
			observedTags,
		),
...
func (e *external) Create(
	...
	createOpts := buildNATGatewayCreateOpts(cr.Spec.ForProvider)

	created, err := natgateways.Create(e.natV2Client, createOpts).Extract()
	if err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, errCreateNATGateway)
	}
	...
	if err != nil {
		return managed.ExternalCreation{}, errors.Wrap(err, errUpdateNATGateway)
	}
...
func (e *external) Update(
	...
	if err := validateImmutableNATGatewayFields(cr.Spec.ForProvider, observed); err != nil {
		return managed.ExternalUpdate{}, errors.Wrap(err, errValidateSpec)
	}

	if err := e.update(externalName, cr.Spec.ForProvider, observed); err != nil {
		return managed.ExternalUpdate{}, errors.Wrap(err, errUpdateNATGateway)
	}
...
func (e *external) Delete(
	...
	if err := natgateways.Delete(e.natV2Client, externalName).ExtractErr(); err != nil {
		...
		return managed.ExternalDelete{}, errors.Wrap(err, errDeleteNATGateway)
	}
...
func buildNATGatewayCreateOpts(spec networkv1alpha1.NATGatewayParameters) natgateways.CreateOpts {
...
func (e *external) update(
	...
	opts, needsUpdate := buildNATGatewayUpdateOpts(spec, observed)
	if !needsUpdate {
		return nil
	}
...
func buildNATGatewayUpdateOpts(
	spec networkv1alpha1.NATGatewayParameters,
	observed natgateways.NatGateway,
...
func (e *external) observeCurrentState(
	...
	if err != nil {
		return natgateways.NatGateway{}, nil, errors.Wrap(err, errObserveNATGateway)
	}
...
func (e *external) setConditions(cr *networkv1alpha1.NATGateway, observedStatus string) {
...
func validateNATGatewayParameters(p networkv1alpha1.NATGatewayParameters) error {
	if p.Name == "" {
...
func validateImmutableNATGatewayFields(
	spec networkv1alpha1.NATGatewayParameters,
	observed natgateways.NatGateway,
) error {
