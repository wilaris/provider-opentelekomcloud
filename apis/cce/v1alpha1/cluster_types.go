...
// +kubebuilder:validation:XValidation:rule="oldSelf.clusterVersion == null || self.clusterVersion == oldSelf.clusterVersion",message="clusterVersion is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.containerNetworkCidr == null || self.containerNetworkCidr == oldSelf.containerNetworkCidr",message="containerNetworkCidr is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.authenticationMode == null || self.authenticationMode == oldSelf.authenticationMode",message="authenticationMode is immutable after creation"
...
// +kubebuilder:validation:XValidation:rule="oldSelf.billingMode == null || self.billingMode == oldSelf.billingMode",message="billingMode is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.highwaySubnetId == null || self.highwaySubnetId == oldSelf.highwaySubnetId",message="highwaySubnetId is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.enableVolumeEncryption == null || self.enableVolumeEncryption == oldSelf.enableVolumeEncryption",message="enableVolumeEncryption is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.eniSubnetId == null || self.eniSubnetId == oldSelf.eniSubnetId",message="eniSubnetId is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.eniSubnetCidr == null || self.eniSubnetCidr == oldSelf.eniSubnetCidr",message="eniSubnetCidr is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.kubeProxyMode == null || self.kubeProxyMode == oldSelf.kubeProxyMode",message="kubeProxyMode is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.kubernetesSvcIpRange == null || self.kubernetesSvcIpRange == oldSelf.kubernetesSvcIpRange",message="kubernetesSvcIpRange is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.multiAz == null || self.multiAz == oldSelf.multiAz",message="multiAz is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.enableDeletionProtection == null || self.enableDeletionProtection == oldSelf.enableDeletionProtection",message="enableDeletionProtection is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.noAddons == null || self.noAddons == oldSelf.noAddons",message="noAddons is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.masters == null || self.masters == oldSelf.masters",message="masters is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.authenticatingProxy == null || self.authenticatingProxy == oldSelf.authenticatingProxy",message="authenticatingProxy is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.labels == null || self.labels == oldSelf.labels",message="labels is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.annotations == null || self.annotations == oldSelf.annotations",message="annotations is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.timezone == null || self.timezone == oldSelf.timezone",message="timezone is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.extendParam == null || self.extendParam == oldSelf.extendParam",message="extendParam is immutable after creation"
// +kubebuilder:validation:XValidation:rule="oldSelf.apiAccessTrustlist == null || self.apiAccessTrustlist == oldSelf.apiAccessTrustlist",message="apiAccessTrustlist is immutable after creation"
...
// +kubebuilder:validation:XValidation:rule="oldSelf.customSan == null || self.customSan == oldSelf.customSan",message="customSan is immutable after creation (the CCE API has no update path)"
